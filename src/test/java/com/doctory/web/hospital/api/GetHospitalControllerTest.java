...
class GetHospitalControllerTest {
    ...
    void test_find_hospital_info_by_id_with_success_response_status_200() throws Exception {
        ...
        var mvcResult = mockMvc.perform(get("/api/hospital").contentType(MediaType.APPLICATION_JSON).param("id", String.valueOf(id))).andExpect(status().is2xxSuccessful()).andReturn();
    ...
    @Test
    void test_not_find_hospital_info_by_id_with_error_response_status_400() throws Exception {
        ...
        var mvcResult = mockMvc.perform(get("/api/hospital").contentType(MediaType.APPLICATION_JSON).
