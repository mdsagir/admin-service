...
public record HospitalDto(Long id, String hospitalName, String foundedAt, String addressLine1, String addressLine2,
    ...
    public static HospitalDto of(Long id, String hospitalName, String foundedAt, String addressLine1, String addressLine2, String pinCode, String state, String country, LocalDateTime created, LocalDateTime modified) {
        return new HospitalDto(id, hospitalName, foundedAt, addressLine1, addressLine2, pinCode, state, country, created, modified);
    }
