...
public record HospitalDto(Long id, String hospitalName, String foundedAt, String addressLine1, String addressLine2,
    ...
    public HospitalDto(Hospital hospital) {
        this(hospital.getId(), hospital.getHospitalName(), hospital.getFoundedAt(),
                hospital.getAddress().getAddressLine1(), hospital.getAddress().getAddressLine2(), hospital.getAddress().getPinCode(),
               hospital.getAddress().getState(), hospital.getAddress().getCountry());
    }
